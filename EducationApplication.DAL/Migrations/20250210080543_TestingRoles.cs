    ...
    public partial class TestingRoles : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamsResult", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExamsResult_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ExamsResult_Exams_ExamId",
                        column: x => x.ExamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AnswerResults_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AnswerResults_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnswerResults_StudentId",
                table: "AnswerResults",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamsResult_ExamId",
                table: "ExamsResult",
                column: "ExamId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamsResult_StudentId_ExamId",
                table: "ExamsResult",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizResults_StudentId_QuizId",
                table: "QuizResults",
